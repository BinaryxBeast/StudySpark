        ...
        >
            {theme === 'light' ? (
                ...
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M12 3C7.03 3 3 7.03 3 12C3 16.97 7.03 21 12 21C16.97 21 21 16.97 21 12C21 11.54 20.96 11.08 20.9 10.64C19.92 11.47 18.69 12 17.34 12C14.21 12 11.66 9.45 11.66 6.32C11.66 4.97 12.19 3.74 13.02 2.76C12.68 2.67 12.34 2.62 12 2.62C12 2.87 12 3 12 3Z" fill="currentColor" />
                </svg>
            ) : (
